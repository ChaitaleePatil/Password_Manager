...
def generate_password():
    ...
    nr_uppercase_alphabets = random.randint(2, 4)
    nr_lowercase_alphabets = random.randint(8, 10)
    nr_special_characters = random.randint(2, 4)

    password_list = []
    for char in range(nr_digits):
        password_list.append(random.choice(digits))
    for char in range(nr_uppercase_alphabets):
        password_list.append(random.choice(uppercase_alphabets))
    for char in range(nr_lowercase_alphabets):
        password_list.append(random.choice(lowercase_alphabets))
    for char in range(nr_special_characters):
